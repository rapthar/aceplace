        ...
        <div className="flex items-center">
          {categories.map(({ icon: Icon, label, value, gradient }) => (
            <button
              ...
              className={`flex items-center gap-2 px-8 py-4 text-sm font-medium relative ${
          ...
          <div className="ml-auto flex items-center gap-2 py-4">
            <div className="flex items-center gap-2 bg-gray-50 rounded-full px-4 py-2">
              ...
              <span className="text-sm font-medium">Dubai City</span>
              <span className="text-sm text-gray-500">Jumeirah</span>
            </div>
          </div>
        </div>
      </div>
